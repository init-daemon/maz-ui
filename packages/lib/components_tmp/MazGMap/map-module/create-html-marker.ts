...
export const createHTMLMarker = (options: {
  ...
  class HTMLMarker extends google.maps.OverlayView {
    private readonly api: typeof google.maps = options.api
    ...
    constructor() {
      ...
      if (isLiteralPosition) {
        ...
        this.latLng = new api.LatLng(literalPosition.lat, literalPosition.lng)
      } else {
    ...
    private createDiv(): void {
      ...
      this.api.event.addDomListener(this.container, 'click', () => {
        this.api.event.trigger(this, 'click')
      })
    }
