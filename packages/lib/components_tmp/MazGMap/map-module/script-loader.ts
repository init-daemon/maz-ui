...
export class ScriptLoader {
  ...
  private resolveScript: (value: typeof google.maps) => void
  public api: typeof google.maps
  ...
  constructor(
    ...
    if (typeof window === 'undefined')
      throw new TypeError('[MazGMap ScriptLoader]: Map is supported only on browser side')
  ...
  private getUrl(): string {
    try {
      ...
      throw new Error(`[MazGMap]: ${error}`)
    }
  }

  public init(): Promise<typeof google.maps> {
