...
<script lang="ts" setup>
  ...
  const ChevronLeftIcon = defineAsyncComponent(() => import('./../icons/chevron-left.svg?component'))
  const ChevronRightIcon = defineAsyncComponent(() => import('./../icons/chevron-right.svg?component'))
