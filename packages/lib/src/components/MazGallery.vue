...
<script lang="ts" setup>
  ...
  import { vFullscreenImg } from './../directives/v-fullscreen-img/fullscreen-img.directive'
  import { vLazyImg } from './../directives/v-lazy-img/lazy-img'
  import type { MazGalleryImage } from './types'
  export type { MazGalleryImage } from './types'

  const NoPhotographyIcon = defineAsyncComponent(() => import('./../icons/no-photography.svg?component'))
