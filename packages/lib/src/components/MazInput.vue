...
<script lang="ts" setup>
  ...
  const EyeOffIcon = defineAsyncComponent(() => import('./../icons/eye-slash.svg?component'))
  const EyeIcon = defineAsyncComponent(() => import('./../icons/eye.svg?component'))
  const CheckIcon = defineAsyncComponent(() => import('./../icons/check.svg?component'))
