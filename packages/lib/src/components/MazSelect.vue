...
<script lang="ts" setup>
  ...
  import { useInstanceUniqId } from '../composables/use-instance-uniq-id'
  import { debounceCallback } from './../utils/debounce-callback'
  ...
  const ChevronDownIcon = defineAsyncComponent(() => import('./../icons/chevron-down.svg?component'))
  const NoSymbolIcon = defineAsyncComponent(() => import('./../icons/no-symbol.svg?component'))
