...
<script lang="ts" setup>
  ...
  const CheckCircleIcon = defineAsyncComponent(() => import('./../icons/check-circle.svg?component'))
  const ExclamationCircleIcon = defineAsyncComponent(
    () => import('./../icons/exclamation-circle.svg?component'),
  )
  const ExclamationIcon = defineAsyncComponent(() => import('./../icons/exclamation-triangle.svg?component'))
