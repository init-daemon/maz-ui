...
<script lang="ts" setup>
  ...
  const SearchIcon = defineAsyncComponent(() => import('./../icons/magnifying-glass.svg?component'))
  const ArrowIcon = defineAsyncComponent(() => import('./../icons/arrow-up.svg?component'))
  const ChevronIcon = defineAsyncComponent(() => import('./../icons/chevron-left.svg?component'))
  const ChevronDoubleIcon = defineAsyncComponent(() => import('./../icons/chevron-double-left.svg?component'))

  export type { Size, Color, MazSelectOption }
