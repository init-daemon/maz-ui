...
<script lang="ts" setup>
  ...
  const XIcon = defineAsyncComponent(() => import('./../../icons/x-mark.svg?component'))
  const ExternalLink = defineAsyncComponent(
    () => import('./../../icons/arrow-top-right-on-square.svg?component'),
  )
  const ExclamationTriangle = defineAsyncComponent(
    () => import('./../../icons/exclamation-triangle.svg?component'),
  )
  const ExclamationCircle = defineAsyncComponent(
    () => import('./../../icons/exclamation-circle.svg?component'),
  )
  const InformationCircle = defineAsyncComponent(
    () => import('./../../icons/information-circle.svg?component'),
  )
  const CheckCircle = defineAsyncComponent(() => import('./../../icons/check-circle.svg?component'))
  const Link = defineAsyncComponent(() => import('./../../icons/link.svg?component'))
